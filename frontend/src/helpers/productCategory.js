const productCategory = [
    { id : 1, label : "Cricket", value : "Cricket"},
    { id : 2, label : "Team Sport", value : "Team Sport"},
    { id : 3, label : "Athletics", value : "Athletics"},
    { id : 4, label : "Boxing", value : "Boxing"},
    { id : 5, label : "Fitness", value : "Fitness"},
